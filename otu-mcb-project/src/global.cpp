...
// tap::motor::DjiMotor right_turret_motor(src::DoNotUse_getDrivers(), right_shooter_MOTOR_ID, CAN_BUS2, false, "right shooter");
// tap::motor::DjiMotor left_turret_motor(src::DoNotUse_getDrivers(), left_shooter_MOTOR_ID, CAN_BUS2, false, "left shooter");
